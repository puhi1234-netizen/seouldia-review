...
const fallbackReviews = [
  "마곡역 근처에서 치과를 찾다가 서울디아치과에 방문했어요. 처음엔 조금 긴장했는데 설명을 차분하게 들을 수 있어서 생각보다 편했습니다.",
  "치과 진료가 걱정돼서 미루고 있었는데, 방문해보니 안내도 편하고 설명도 이해하기 쉬웠어요. 마곡 치과 찾는 분들이 참고해도 좋을 것 같습니다.",
  "처음 방문이라 조심스러웠는데 병원 분위기가 깔끔하고 상담도 부담스럽지 않았습니다. 필요한 부분을 하나씩 설명해주셔서 결정하는 데 도움이 됐어요.",
];
...
[첫 문장 패턴 후보 50개]
1. 집 근처라 방문했어요.
2. 마곡 치과를 알아보다가 예약했습니다.
3. 마곡역 치과를 찾다가 서울디아치과를 알게 됐어요.
...
29. 마곡 쪽으로 이사 와서 새 치과를 찾고 있었습니다.
...
40. 마곡 임플란트 검색하다가 알게 됐습니다.
41. 마곡 라미네이트 알아보다가 예약했어요.
...
- 출력은 리뷰 문장만 작성합니다.
- 따옴표, 번호, 제목 없이 작성합니다.
- "간단하게" 선택 시 2~3문장, 120~230자 정도로 작성합니다.
- "자세하게" 선택 시 3~5문장, 230~430자 정도로 작성합니다.

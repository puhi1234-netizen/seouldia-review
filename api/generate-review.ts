...
- 실제 리뷰처럼 "좋았음", "처음이라 걱정했는데", "설명 잘 들었어요", "생각보다 편했어요", "검진받고 왔어요" 같은 예시를 참고하되 그대로 쓰지말고 다양하게 생활감 있는 시작을 우선하세요.
...
12. 첫 문장은 지역명보다 환자의 상황, 치료 걱정, 방문 느낌, 짧은 평가로 시작하세요. 처음, 첫방문 등 방문유형을 첫문장에 넣지 마세요
